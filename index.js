...
if(behavior === "Good"){
  human = "Finleigh was good today!";
}else{
  human = "Finleigh was bad today!";
}

console.log("task 1b:", human);
...
console.log("task 1d:", multiply(7,3));
...
console.log("task 2:", dogYears(43))
